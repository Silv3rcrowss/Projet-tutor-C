...
int test_permute_ligne()
{
	...
	for(i=1;i<=3;i++)
	{
		if(get_case(g,1,i)!=tab2[i] || get_case(g,2,i)!=tab1[i])
			return 0;
	}
	fclose(f);
	return 1;
...
int test_permute_nombres()
{
	...
	if(get_case(g,1,1) != 2 || get_case(g,1,2) != 1 || get_case(g,2,2)!= 1 || get_case(g,2,3) != 2 )
		return 0;
	return 1;
...
int main()// main de test
{
	srand(time(NULL));
	printf("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~TEST~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n");
	if(test_nombre_aleatoire())
	{
		color_printf(WHITE,GREEN," Complete ");
		printf(": test_nombre_aleatoire()\n");
	}
	else
	{
		color_printf(WHITE,RED,"  Failed  ");
		printf(": test_nombre_aleatoire()\n");
	}
	if(test_permute_ligne())
	{
		color_printf(WHITE,GREEN," Complete ");
		printf(": test_permute_ligne()\n");
	}
	else
	{
		color_printf(WHITE,RED,"  Failed  ");
	...
	if(test_permute_nombres())
	{
		color_printf(WHITE,GREEN," Complete ");
		printf(": test_permute_nombres()\n");
	}
	else
	{
		color_printf(WHITE,RED,"  Failed  ");
